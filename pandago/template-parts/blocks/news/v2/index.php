 ...
 * Terms:
 * terms
 *   enabled  - Whether to enable term filter
...
$options = array(
    ...
    'button' => array(
        ...
        'title' => ( $setup[ 'button' ][ 'title' ] ) ? $setup[ 'button' ][ 'title' ] : __( 'Visi jaunumi', PANDAGO_TD ),
...
<?php if ( $query->have_posts() ): ?>
    ...
    <?php if ( $options[ 'standalone' ] ): ?>
        <section class="pdg-block pdg-block-news pdg-block-news-v2" data-same-height="title,excerpt">
            <div class="container">
    <?php else: ?>
        <div class="pdg-block pdg-block-news pdg-block-news-v2" data-same-height="title,excerpt">
    <?php endif; ?>
            ...
            <div class="pdg-posts row">
                ...
                ?>
                    <div class="pdg-post-wrap <?php echo $options[ 'col_class' ]; ?> <?php if ( $i == 0 ): ?>first<?php endif; ?>">
                        <?php
                        get_template_part( 'template-parts/blocks/news/v2/post' );
                        ?>
                    </div>
                <?php
                    $i++;
