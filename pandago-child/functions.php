...
//   wp_enqueue_script('scripts_themes', get_stylesheet_directory_uri() .'/resources/theme.js');
}
...
function my_acf_init_block_types() { 
    ...
    if( function_exists('acf_register_block_type') ) {
        ...
        acf_register_block_type(array(   // Text-Block
            ...
            'enqueue_style'     => get_stylesheet_directory_uri() . '/assets/css/style.css',
            // 'enqueue_style'     => get_stylesheet_directory_uri() . '/assets/theme.js',
